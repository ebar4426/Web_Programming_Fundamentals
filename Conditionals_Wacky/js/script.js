...
var firstDesision;//first desision variable
var secondDesision;//second dessision variable
var thirdDesision;//third desision variable
alert("This is a decision making story! Lets begin, to set the location you arrive at a dark and spooky house that you have to inspect. There are lots of rumors about this place. You are a reporter that’s never been scared of a challenge. You want to get the scoop on this place, it could make your carrer. Your boss gave you a deadline of tomorrow. Wanting the best time for paranormal activity you decide to go tonight! You have your head camera and headset to document all your adventures. To make matters worse, a huge storm is rolling in. You've been given a key by the owners of the property. You open the front door and step inside......"); //intro alert
firstDesision = prompt("You step inside a very dusty entrance. You hear foot steps up the stairs and start to see a shadow. You take up your options. You can go up stairs or can leave right now before it gets bad. Make your desision. Type 1 to go upstairs, Type 2 to go out front door.");
if(firstDesision === "1"){
